...
// `gmk schema` — emit a JSON Schema describing the gmk.yml file format.
//
...
func newSchemaCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "schema",
		Short: "Emit a JSON Schema for gmk.yml (for editor LSPs)",
		Long: `Print a JSON Schema (draft 2020-12) describing the gmk.yml file format.
...
Then in .vscode/settings.json:
  "yaml.schemas": { ".gmk.schema.json": ["gmk.yml", "gmk/*.yml"] }
...
func buildSchemaDoc() map[string]any {
	return map[string]any{
		...
		"$id":         "https://github.com/suhrut/gmk/schema/v0.4/gmk.yml.json",
		"title":       "gmk.yml",
		"description": "Schema for gmk Stage 3c project files.",
		"type":        "object",
